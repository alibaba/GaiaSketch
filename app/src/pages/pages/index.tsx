...
export function Page(props: IPageProps) {
    ...
    useEffect(() => {
        window.onDidDeletePages = () => {
            setSelectedLibraryInfo(null);
            setAreaContent(null);
            setOptions([]);
            setLoading(true);
            setTimeout(() => {
                window.postMessage("getPageLibraries", true);
            }, 100);
        };
    ...
    useEffect(() => {
        setTimeout(() => {
            window.postMessage("getPageLibraries");
        }, 100);
    }, []);

    useEffect(() => {
        window.onDidGetPages = (data: any) => {
            setLoading(false);
            setAreaContent(
                <Nav
                    styles={{
    ...
    useEffect(() => {
        if (selectedLibraryInfo) {
            if (selectedLibraryInfo.libraryID) {
                setLoading(true);
                setTimeout(() => {
                    window.postMessage("getPages", selectedLibraryInfo, forceReload);
    ...
    useEffect(() => {
        window.onDidUpdateLibrary = (data: any) => {
            if (data && data.type === BarType.Page && data.libraryInfo) {
    ...
    useEffect(() => {
        window.onDidImportPages = (data: any) => {
                    ...
                    <IconButton
                        ...
                        onClick={() => {
                            ...
                            if (selectedLibraryInfo) {
                                setLoading(true);
                                setTimeout(() => {
                                    window.postMessage("getPages", selectedLibraryInfo, true);
                                }, 100);
                            } else {
                                setTimeout(() => {
                                    window.postMessage("getPageLibraries", true);
                            ...
                            items: [
                                {
                                    ...
                                    onClick: () => {
                                        setTimeout(() => {
                                            window.postMessage("importPages");
                                        }, 100);
                                    }
                                },
                                {
                                    ...
                                    onClick: () => {
                                        setTimeout(() => {
                                            window.postMessage("deletePage", selectedLibraryInfo);
                                        }, 100);
                                    }
                                },
                                {
