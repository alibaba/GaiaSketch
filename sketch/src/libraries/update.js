...
export function setupCheckUpdateInterval(context, webContents) {
    ...
    updateInterval = setInterval(async () => {
        ...
        needUpdateLibraries = needUpdateLibraries.concat(await checkAllLocalLibraries(Style));
        needUpdateLibraries = needUpdateLibraries.concat(await checkAllLocalLibraries(Iconfont));
        needUpdateLibraries = needUpdateLibraries.concat(await checkAllLocalLibraries(Page));
        webContents.executeJavaScript(
